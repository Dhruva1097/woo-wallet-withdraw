...
if (!class_exists('WOO_Wallet_Withdrawal_Reject')) :
    ...
    class WOO_Wallet_Withdrawal_Reject extends WC_Email {
        ...
        public function __construct() {
            ...
            $this->title = __('Wallet withdraw reject', 'woo-wallet-withdrawal');
            $this->description = __('These emails are sent to user when a wallet withdraw request is cancelled', 'woo-wallet-withdrawal');
        ...
        public function get_default_subject() {
            return __('[{site_name}] Your withdrawal request was cancelled', 'woo-wallet-withdrawal');
        }
        ...
        public function get_default_heading() {
            return __('Withdrawal request for {amount} was cancelled', 'woo-wallet-withdrawal');
        }
